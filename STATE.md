...
| Readiness boundary | No failed systemd units at 15:13:16. `liquidity-migration-demo-liveness.timer` is inactive from about 14:33, so the demo realm is unwatched and the host watchdog pages `watchdog:demo`. The eighteen native stops matching position quantities are the 10:25:30 reading and predate the three mainnet reductions at 15:10:29 and 15:11:11; no native stop or position reading is taken since. These are sampled host observations, not a complete production-day replay |
