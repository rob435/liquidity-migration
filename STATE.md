...
- Active systems are the old deployed continuous fade book and the long-native v11a
  demo/paper sleeve.
...
The operator reverted the research anchor to the old deployed system on 2026-06-17.
The abandoned staged program is removed from the hot path. Do not use its receipts,
helper scripts, or artifact directories as binding evidence for promotion,
deployment, or parameter changes.
...
- Operator-gated stability fixes for the old deployed continuous system.
...
1. Revert the continuous demo + paper `BTC_TREND_GATE` from `off` back to `uptrend` after
   the plumbing test is confirmed.
...
- `docs/preregistration/continuous-hedge-2f-engine-2026-06-10.md`
...
- `docs/preregistration/continuous-forward-clock-spec-2026-06-09.md`
