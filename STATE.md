...
| Pending source change | Locally verified LONG demo 30 s GTC entry policy and worked-entry restart cancellation; 1,314 focused Rust tests, 42 focused Python tests and strict Rust 1.90 Clippy pass. Deployment evidence below still describes `329ba5dc`; the new policy is not yet active |
