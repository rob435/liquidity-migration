...
| Observation | Value |
| --- | --- |
| Verified at | 2026-09-07 08:24:41 UTC authenticated native positions/stops, services, heartbeats, disk and loaded images during local WAL-converter qualification |
| Evidence | [Deploy run `34085705580`](https://github.com/rob435/liquidity-migration/actions/runs/34085705580); native read `/tmp/r3-native-wal-converter-before.json`; services/images `/tmp/r3-host-wal-converter-before.json`; workflow log `/tmp/r3-deploy-905c10d3-complete.log`; drill log `/tmp/r3-demo-selected-pair-run.log` |
...
| Disk | 29.13 GiB free on `/var/lib`; research tape reserves 25 GiB and the host liveness alarm is 5 GB. All 59 demo and 58 mainnet WAL files remain present. No retained reader is removed |
