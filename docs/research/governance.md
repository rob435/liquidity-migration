...
| Benchmark | A price known at decision time: the arrival midpoint from the first valid book within 2 s of the decision, with the decision clock bridged to WAL wall time | Implemented in [execution-study.md](../execution-study.md); unresolved clocks and stale or gapped books leave the arm unscored |
