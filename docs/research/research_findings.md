...
| **MAKER (`lane2_toxic_flow_quoter_v1`)** | 2026-08-03 and 2026-08-04 Bybit tape; every grid arm shaped and graded on both dates | n/a | n/a | **REGISTERED / QUOTING DISABLED** | Absolute net −0.171 bp per quote opportunity with an available mark, against −0.248 bp for the fee-corrected control; every full-fee arm is negative, at a modelled 4 bp maker round trip below the account's observed 3.6–4 bp per side. The forward sample stopped at 10 fills and is a diagnostic. [Registry row](governance.md). |
