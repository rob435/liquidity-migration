...
`docs/preregistration/account_execution_calibration_v5_2026_07_14.md`. V4 is a
retained failed first-target pilot and must not be resumed or merged. V5 supplies
