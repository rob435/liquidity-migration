...
| `equity [ARGS]` | Descriptive equity curves. `--sleeves long,carry` (`carry` renders the deployed rule `configs/lane2_carry_hold_v6.json` from the cross-venue panel, not a daemon replay), `--years N`. |
