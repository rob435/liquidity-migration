...
class DailyCloseFadeConfig:
    ...
    vol_trailing_stop_mult: float = 0.25
    vol_trailing_activation_mult: float = 0.0
    mfe_giveback_activation_pct: float = 0.01
    mfe_giveback_pct: float = 0.20
    vwap_reversion_pct: float = 0.0
    stop_delay_minutes: int = 0
    profit_protection_delay_minutes: int | None = 15
...
class DailyCloseFadeGridConfig:
    ...
    liquidity_rank_mins: tuple[int, ...] = (31,)
