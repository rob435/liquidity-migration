...
from liquidity_migration.marketdata.binance import BinanceDataError, BinanceUSDMData, _recent_history_start
...
def download_binance_usdm_proxy_data(
    ...
    *,
    ...
    from liquidity_migration.data.binance_vision import _assert_download_completeness
