...
from liquidity_migration.core.config import DEFAULT_EXCLUDED_SYMBOLS, ResearchConfig
...
from liquidity_migration.account.strategy_funnel import DecisionFunnelObserver
...
class LivePanelCache:
    ...
    `tests/strategy/test_continuous_demo.py` pins it. The full
