...
from liquidity_migration.research.backtest.continuous_profile import active_hedge_regime, active_hedge_rule
...
def compute_hedge_decision_2f(
    ...
    *,
    ...
    """
    from liquidity_migration.research.backtest.continuous_rebalance import plan_continuous_hedge_resize
