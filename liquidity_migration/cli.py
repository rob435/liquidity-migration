...
def _cmd_continuous_event_demo_cycle(args: argparse.Namespace, config: ResearchConfig, data_root: Path) -> int:
        ...
        cont_demo_config = ContinuousDemoCycleConfig(
            ...
            entry_portfolio_heat_cap_frac=args.entry_portfolio_heat_cap_frac,
            entry_portfolio_heat_shock_frac=args.entry_portfolio_heat_shock_frac,
            entry_account_drawdown_kill_switch_frac=args.entry_account_drawdown_kill_switch_frac,
            submit_orders=args.submit_orders,
