...
never configuration inputs.
    ...
    PYTHONIOENCODING=utf-8 POLARS_MAX_THREADS=6 .venv/bin/python \
        scripts/research/continuous_deployed_equity_refresh.py --end-date YYYY-MM-DD
    ...
    *,
    ...
    report = "\n".join(
        [
            ...
            "",
            (
                "Standard equity-curve runner: scripts/research/equity_curves.sh -> "
                "scripts/research/equity_curves.py -> scripts/research/continuous_deployed_equity_refresh.py."
            ),
