...
restore="$(embedded "$(encode scripts/vps/vps_restore_ssh_access.sh)" liquidity-migration-ssh-restore)"
rescue="$(embedded "$(encode scripts/vps/vps_rescue_restore_ssh_access.sh)" liquidity-migration-rescue-restore)"
