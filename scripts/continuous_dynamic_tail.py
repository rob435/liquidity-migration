...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh continuous dynamic liquidation/outage diagnostics.")
    parser.add_argument("--output-root", default=str(DEFAULT_OUTPUT_ROOT))
    parser.add_argument("--venues", default="bybit,binance")
    parser.add_argument("--no-report", action="store_true", help="Only write dynamic_liquidation_outage.csv")
...
def main() -> int:
    ...
    artifacts = harness.write_dynamic_liquidation_outage_tables(output_root, trades)
