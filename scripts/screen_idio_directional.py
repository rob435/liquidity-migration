...
Everything in ``scripts/screen_idio_charts.py`` is a cross-sectional decile
...
Dispatch:
    .venv/bin/python -u scripts/screen_idio_directional.py \\
...
from liquidity_migration._common import calendar_roll  # noqa: E402
