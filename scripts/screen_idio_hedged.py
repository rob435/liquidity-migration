...
The idio-chart screen (``scripts/screen_idio_charts.py``) reports every signal
...
Dispatch:
    .venv/bin/python -u scripts/screen_idio_hedged.py \\
...
from scripts.screen_idio_charts import (  # noqa: E402
    ALL_SOURCES,
    DAYS_PER_YEAR,
    bonferroni_t,
    realized_turnover,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if "btc_beta" not in panel.columns:
        raise SystemExit("panel lacks btc_beta; rebuild with the current scripts/build_idio_panel.py")
