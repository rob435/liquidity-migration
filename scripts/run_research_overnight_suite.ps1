...
try {
    ...
    if (-not $SkipResearchLog) {
        ...
        $ArtifactArgs = @(
            ...
            "--next-step", "Review research_log.md, corrected readiness gates, promotion reports, and any failing gates before changing config.",
            ...
            "--constraint", "Daily-close promotion reports generated before the 2026-05-08 profit-protection fix are invalid.",
            "--tag", "overnight",
            "--config", $Config,
