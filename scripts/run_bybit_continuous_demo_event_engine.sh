...
ENTRY_PORTFOLIO_HEAT_CAP_FRAC="${ENTRY_PORTFOLIO_HEAT_CAP_FRAC:-0}"
ENTRY_PORTFOLIO_HEAT_SHOCK_FRAC="${ENTRY_PORTFOLIO_HEAT_SHOCK_FRAC:-1}"
...
exec "$PYTHON_BIN" -m liquidity_migration \
    ...
    --entry-portfolio-heat-cap-frac "$ENTRY_PORTFOLIO_HEAT_CAP_FRAC" \
    --entry-portfolio-heat-shock-frac "$ENTRY_PORTFOLIO_HEAT_SHOCK_FRAC" \
