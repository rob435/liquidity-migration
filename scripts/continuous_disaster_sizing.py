...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh continuous disaster-loss sizing diagnostics.")
    parser.add_argument("--output-root", default=str(DEFAULT_OUTPUT_ROOT))
    parser.add_argument("--venues", default="bybit,binance")
    parser.add_argument("--no-report", action="store_true", help="Only write disaster sizing tables")
...
def main() -> int:
    ...
    artifacts = harness.write_disaster_sizing_tables(output_root, trades)
