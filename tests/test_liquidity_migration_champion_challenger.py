...
def test_champion_challenger_audit_allows_only_promoted_submitter(tmp_path: Path) -> None:
    ...
    assert submitters[0]["challenger_id"] == "champion_promoted_submit"
    assert "STRATEGY_PROFILE=promoted" in submitters[0]["command"]
