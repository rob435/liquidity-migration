...
## Corpus Check
- 28 files · ~37,623 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 457 nodes · 1117 edges · 11 communities detected
...
Cohesion: 0.05
Nodes (94): CostConfig, TradeLifecycleConfig, build_equity_curve(), _add_rank_fraction(), _apply_market_context_filters(), _attach_event_archive_membership(), _attach_market_context(), _bottom_cut_from_top_cut() (+86 more)
...
Cohesion: 0.1
Nodes (45): ArchiveHourlyKlineApiDownloadConfig, ArchiveHourlyKlineDownloadConfig, ArchiveKlineDownloadConfig, ArchiveManifestConfig, format_archive_manifest_report(), _rows_by_date(), run_archive_klines_download(), run_archive_manifest() (+37 more)
...
Cohesion: 0.09
Nodes (31): _bar_excursion(), _bar_exit_hits(), _date_boundary_ms(), _empty_baskets(), _exit_reason_rows(), _filter_signal_window(), _filter_universe(), _funding_lookup() (+23 more)
...
- **Why does `run_event_demo_cycle()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 8`?**
...
- **Why does `BybitMarketData` connect `Community 3` to `Community 1`, `Community 2`, `Community 6`?**
