...
## Summary
- 780 nodes · 2490 edges · 10 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 826 edges (avg confidence: 0.77)
...
Cohesion: 0.05
Nodes (92): _active_position_by_symbol(), _bool(), _build_demo_features(), _build_demo_universe(), build_event_risk_private_client(), build_ledger_position_pnl_snapshot(), build_position_pnl_snapshot(), _build_private_client() (+84 more)
...
Cohesion: 0.04
Nodes (42): BybitDataError, BybitPrivateClient, BybitPrivateWebSocketStream, BybitPublicTickerStream, BybitPublicTradeStream, BybitWebSocketTradeClient, _close_ws_client(), _is_rate_limit() (+34 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (75): _base36(), _decimal_text(), EventDemoCycleConfig, EventRiskCycleConfig, _execute_entries(), _execute_exits(), _execute_risk_exits(), _execution_summary() (+67 more)
...
Cohesion: 0.07
Nodes (52): download_archive_bytes(), _download_archive_to_path(), _public_trade_text_handle(), read_public_trade_archive(), read_public_trade_archive_klines_1h(), _read_public_trade_archive_klines_1h_vectorized(), TradeFlowConfig, _archive_filename() (+44 more)
