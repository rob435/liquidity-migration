...
## Corpus Check
- 68 files · ~91,916 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 998 nodes · 2528 edges · 34 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 556 edges (avg confidence: 0.77)
...
Cohesion: 0.07
Nodes (93): CostConfig, DailyCloseFadeConfig, DailyCloseFadeGridConfig, _apply_basket_stop_to_rows(), apply_close_fade_basket_stop(), _attach_archive_membership(), attach_close_fade_coin_market_context(), attach_close_fade_position_sizing() (+85 more)
...
Cohesion: 0.06
Nodes (60): BybitDataError, BybitPrivateClient, _evaluate_grid_variant_worker(), _demo_cycle_lock(), _as_utc(), build_demo_sync_orders(), _build_limit_order(), _build_probe_order() (+52 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (62): _close_fade_position_weight(), _as_utc(), _basket_already_opened(), _bool_value(), build_forward_scan_features(), build_forward_universe(), _concat(), _count_reason() (+54 more)

### Community 5 - "Community 5"
Cohesion: 0.13
Nodes (33): BybitMarketData, ResearchConfig, DemoCancelAllConfig, DemoFlattenConfig, DemoProbeConfig, DemoSyncConfig, run_bybit_demo_sync(), _FakeExecution (+25 more)
...
- **Thin community `Community 28`** (5 nodes): `test_daily_close_fade_sizing_sweep_script.py`, `test_build_weighted_baskets_applies_equal_concentration_cap()`, `test_capped_proportional_weights_leaves_cash_when_all_names_hit_cap()`, `test_capped_proportional_weights_redistribute_until_cap()`, `_trade()`
...
- **Thin community `Community 35`** (3 nodes): `_candidate()`, `test_volume_promotion_script.py`, `test_volume_promotion_requires_split_survival_and_drawdown()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (3 nodes): `test_daily_close_fade_grid_splits_script.py`, `test_grid_split_summary_prefers_stable_variants()`, `_variant()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `load_config()` connect `Community 16` to `Community 3`, `Community 5`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 21`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `parse_date_ms()` connect `Community 8` to `Community 0`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 19`, `Community 21`?**
