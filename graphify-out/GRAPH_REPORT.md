...
## Corpus Check
- 38 files · ~80,173 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 966 nodes · 2976 edges · 15 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 832 edges (avg confidence: 0.77)
...
- `test_volume_alpha_isolated_daily_research_path()` --calls--> `build_volume_features()`  [INFERRED]
  tests/test_aggression_carry_volume_alpha.py → aggression_carry/volume_alpha.py
- `_FakeBybit` --uses--> `DailyCloseFadeConfig`  [INFERRED]
  tests/test_aggression_carry_forward_test.py → aggression_carry/config.py
...
Cohesion: 0.05
Nodes (92): _all_context_rate(), _apply_basket_stop_to_rows(), apply_close_fade_basket_stop(), _attach_archive_membership(), attach_close_fade_optional_context(), attach_close_fade_position_sizing(), _attach_funding_context(), _attach_instrument_age() (+84 more)
...
Cohesion: 0.16
Nodes (45): CostConfig, DailyCloseFadeConfig, DailyCloseFadeGridConfig, DailyCloseFadeDiagnosticsConfig, Return canonical entry child timestamps for the daily-close fade., run_daily_close_fade(), read_dataset(), _feature_candidate() (+37 more)

### Community 10 - "Community 10"
Cohesion: 0.11
Nodes (40): _add_forward_fade_args(), _add_forward_runtime_args(), _add_universe_backtest_args(), _apply_universe_backtest_args(), _arg(), _backtest_config_from_args(), build_parser(), _close_fade_base_from_diagnostics_args() (+32 more)
...
- **Why does `read_dataset()` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 12`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `ResearchConfig` connect `Community 5` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 13`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 10` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Are the 95 inferred relationships involving `read_dataset()` (e.g. with `run_volume_trade_backtest()` and `run_volume_grid()`) actually correct?**
  _`read_dataset()` has 95 INFERRED edges - model-reasoned connections that need verification._
