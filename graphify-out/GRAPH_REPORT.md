...
## Corpus Check
- 33 files · ~60,319 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 698 nodes · 2072 edges · 10 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 674 edges (avg confidence: 0.77)
...
Cohesion: 0.06
Nodes (84): _normalize_instruments(), _active_position_by_symbol(), _base36(), _bool(), _build_demo_features(), _build_demo_universe(), build_event_risk_private_client(), build_ledger_position_pnl_snapshot() (+76 more)
...
Cohesion: 0.08
Nodes (25): BybitPrivateWebSocketStream, BybitPublicTickerStream, BybitWebSocketTradeClient, _close_ws_client(), _is_rate_limit(), _column_values(), _open_trades(), _safe_raw_positions() (+17 more)
...
Cohesion: 0.14
Nodes (41): ResearchConfig, read_dataset(), EventWebSocketRiskConfig, test_archive_download_can_build_1m_klines_from_public_trades(), test_rest_kline_download_only_marks_successful_symbols(), test_rest_kline_download_writes_each_symbol_and_resumes(), BlockingPrivateStream, BlockingPublicStream (+33 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (50): UniverseConfig, EventDemoCycleConfig, EventRiskCycleConfig, _execute_entries(), order_quantity_for_notional(), _prices_close(), _reconcile_pending_order_fills(), _round_price() (+42 more)
...
Cohesion: 0.06
Nodes (14): BybitDataError, BybitMarketData, BybitPrivateClient, BybitPublicTradeStream, _leverage_text(), _patch_pybit_daemon_ping_timer(), RuntimeError, _contract() (+6 more)
...
- **Why does `EventWebSocketRiskEngine` connect `Community 3` to `Community 8`, `Community 1`, `Community 5`, `Community 6`?**
