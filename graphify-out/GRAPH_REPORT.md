...
## Corpus Check
- 68 files · ~87,342 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 956 nodes · 2418 edges · 32 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 540 edges (avg confidence: 0.77)
...
4. `DailyCloseFadeConfig` - 34 edges
...
- `test_fixed_slot_baskets_leave_missing_top_n_weight_in_cash()` --calls--> `DailyCloseFadeConfig`  [INFERRED]
  tests/test_daily_close_fade_coin_filter_sweep_script.py → aggression_carry/config.py
...
Cohesion: 0.06
Nodes (104): CostConfig, DailyCloseFadeConfig, DailyCloseFadeGridConfig, VolumeBacktestConfig, VolumeGridConfig, _apply_basket_stop_to_rows(), apply_close_fade_basket_stop(), _attach_archive_membership() (+96 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (91): download_archive_bytes(), download_public_trade_archive(), ArchiveManifestConfig, build_archive_trade_manifest(), _download_one_archive_kline(), _download_result(), _empty_download_results(), _empty_manifest() (+83 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (73): _evaluate_grid_variant_worker(), _demo_cycle_lock(), _attribution_rows(), backtest_volume_trades(), _bar_at_close(), _bar_excursion(), _bar_exit_hits(), _btc_monthly_returns() (+65 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (35): BybitDataError, BybitMarketData, BybitPrivateClient, ResearchConfig, _demo_executor(), DemoCancelAllConfig, DemoFlattenConfig, DemoProbeConfig (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (58): _as_utc(), _basket_already_opened(), _bool_value(), build_forward_scan_features(), build_forward_universe(), _concat(), _count_reason(), _count_status() (+50 more)
...
- **Thin community `Community 29`** (4 nodes): `test_daily_close_fade_split_diagnostics_script.py`, `_scenario()`, `test_parse_splits_requires_ordered_windows()`, `test_split_summary_prefers_scenarios_that_survive_every_split()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (4 nodes): `test_volume_grid_splits_script.py`, `test_parse_splits_requires_ordered_windows()`, `test_volume_grid_split_summary_prefers_stable_variants()`, `_variant()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (3 nodes): `_candidate()`, `test_volume_promotion_script.py`, `test_volume_promotion_requires_split_survival_and_drawdown()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (3 nodes): `test_daily_close_fade_grid_splits_script.py`, `test_grid_split_summary_prefers_stable_variants()`, `_variant()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `main()` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 15`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `load_config()` connect `Community 15` to `Community 2`, `Community 3`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 20`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `read_dataset()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 11`?**
...
- **Are the 32 inferred relationships involving `DailyCloseFadeConfig` (e.g. with `DemoCycleConfig` and `DailyCloseFadeDiagnosticsConfig`) actually correct?**
  _`DailyCloseFadeConfig` has 32 INFERRED edges - model-reasoned connections that need verification._