...
## Corpus Check
- 28 files · ~38,502 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 463 nodes · 1137 edges · 10 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 331 edges (avg confidence: 0.79)
...
3. `VolumeEventResearchConfig` - 29 edges
...
Cohesion: 0.05
Nodes (90): TradeLifecycleConfig, build_equity_curve(), _exit_reason_rows(), _funding_lookup(), _price_bars_by_symbol(), _add_rank_fraction(), _apply_market_context_filters(), _attach_event_archive_membership() (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (82): _base36(), _build_demo_features(), _build_demo_universe(), build_ledger_position_pnl_snapshot(), build_position_pnl_snapshot(), _build_private_client(), _column_values(), _contract_lookup() (+74 more)
...
- **Why does `run_event_demo_cycle()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 8`?**
...
- **Why does `VolumeEventResearchConfig` connect `Community 0` to `Community 8`, `Community 1`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
...
- **Are the 27 inferred relationships involving `VolumeEventResearchConfig` (e.g. with `CostConfig` and `TradeLifecycleConfig`) actually correct?**
  _`VolumeEventResearchConfig` has 27 INFERRED edges - model-reasoned connections that need verification._
