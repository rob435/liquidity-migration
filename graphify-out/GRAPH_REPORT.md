...
## Corpus Check
- 41 files · ~89,849 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1062 nodes · 3261 edges · 14 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 931 edges (avg confidence: 0.77)
...
1. `read_dataset()` - 103 edges
2. `ResearchConfig` - 89 edges
3. `write_dataset()` - 63 edges
4. `main()` - 58 edges
...
Cohesion: 0.03
Nodes (129): download_archive_bytes(), _download_archive_to_path(), download_public_trade_archive(), _archive_kline_skip_rows(), ArchiveHourlyKlineApiDownloadConfig, ArchiveHourlyKlineDownloadConfig, ArchiveKlineDownloadConfig, ArchiveManifestConfig (+121 more)
...
Cohesion: 0.05
Nodes (97): VolumeBacktestConfig, VolumeGridConfig, _evaluate_grid_variant_worker(), generate_fixture_data(), _attribution_rows(), backtest_volume_trades(), _bar_at_close(), _bar_excursion() (+89 more)
...
Cohesion: 0.07
Nodes (58): _add_rank_fraction(), _attach_event_archive_membership(), _bottom_cut_from_top_cut(), _daily_return_frame(), _date_ms(), _date_range(), _enriched_event_features(), _event_decay_exit_hit() (+50 more)
...
Cohesion: 0.08
Nodes (41): ExchangeConfig, load_config(), _merge_daily_close_fade_config(), _merge_daily_close_fade_grid_config(), _merge_dataclass(), _merge_forward_test_config(), _merge_universe_config(), _merge_volume_alpha_config() (+33 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (43): _add_forward_fade_args(), _add_forward_runtime_args(), _add_universe_backtest_args(), _apply_universe_backtest_args(), _arg(), _backtest_config_from_args(), build_parser(), _close_fade_base_from_diagnostics_args() (+35 more)
...
- **Why does `read_dataset()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `ResearchConfig` connect `Community 5` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 9`, `Community 10`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Are the 101 inferred relationships involving `read_dataset()` (e.g. with `run_volume_trade_backtest()` and `run_volume_grid()`) actually correct?**
  _`read_dataset()` has 101 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 58 inferred relationships involving `write_dataset()` (e.g. with `generate_fixture_data()` and `_replace_dataset()`) actually correct?**
  _`write_dataset()` has 58 INFERRED edges - model-reasoned connections that need verification._
- **Are the 38 inferred relationships involving `main()` (e.g. with `load_config()` and `generate_fixture_data()`) actually correct?**
