...
## Corpus Check
- 33 files · ~69,467 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 764 nodes · 2442 edges · 11 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 827 edges (avg confidence: 0.77)
...
8. `FakeRiskClient` - 50 edges
9. `FakePublicStream` - 50 edges
...
Cohesion: 0.07
Nodes (66): EventDemoCycleConfig, EventRiskCycleConfig, _execute_entries(), order_quantity_for_notional(), _prices_close(), _reconcile_pending_order_fills(), _round_price(), _stop_price_for_entry() (+58 more)
...
- **Why does `read_dataset()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 8`?**
