...
## Corpus Check
- 40 files · ~83,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1010 nodes · 3103 edges · 14 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 875 edges (avg confidence: 0.77)
...
Cohesion: 0.04
Nodes (133): VolumeBacktestConfig, VolumeGridConfig, generate_fixture_data(), _attribution_rows(), backtest_volume_trades(), _bar_at_close(), _bar_excursion(), _bar_exit_hits() (+125 more)
...
Cohesion: 0.05
Nodes (96): ForwardTestConfig, attach_close_fade_coin_market_context(), _bar_open(), close_fade_entry_child_schedule_ts_ms(), _short_limit_execution_price(), _short_stop_execution_price(), _vwap_reversion_exit_price(), _mfe_giveback_stop_price() (+88 more)
...
Cohesion: 0.08
Nodes (7): BybitDataError, BybitMarketData, BybitPrivateClient, _is_rate_limit(), _leverage_text(), _demo_executor(), RuntimeError
...
- **Why does `main()` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`?**
