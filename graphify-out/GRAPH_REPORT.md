...
## Corpus Check
- 38 files · ~61,369 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 614 nodes · 1674 edges · 12 communities detected
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 451 edges (avg confidence: 0.77)
...
1. `ResearchConfig` - 45 edges
2. `read_dataset()` - 44 edges
3. `main()` - 43 edges
4. `write_dataset()` - 29 edges
5. `_FakeExecution` - 29 edges
6. `run_volume_trade_backtest()` - 27 edges
7. `DailyCloseFadeConfig` - 24 edges
8. `run_bybit_demo_sync()` - 24 edges
9. `download_market_data()` - 24 edges
10. `_FakeMarket` - 24 edges
...
Cohesion: 0.05
Nodes (68): download_archive_bytes(), download_public_trade_archive(), read_public_trade_archive(), TradeFlowConfig, _replace_dataset(), format_demo_sync_report(), _write_demo_sync_outputs(), _archive_filename() (+60 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (60): _close_fade_position_weight(), _vwap_reversion_exit_price(), _as_utc(), _basket_already_opened(), _bool_value(), build_forward_scan_features(), build_forward_universe(), _concat() (+52 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (64): CostConfig, DailyCloseFadeConfig, _apply_basket_stop_to_rows(), apply_close_fade_basket_stop(), _attach_archive_membership(), _attach_instrument_age(), backtest_daily_close_fade(), _baseline_liquidity_filter_expr() (+56 more)
...
Cohesion: 0.15
Nodes (28): _add_forward_fade_args(), _add_forward_runtime_args(), _add_universe_backtest_args(), _apply_universe_backtest_args(), _backtest_config_from_args(), build_parser(), _close_fade_base_from_grid_args(), _close_fade_config_from_args() (+20 more)

### Community 8 - "Community 8"
Cohesion: 0.13
Nodes (27): DailyCloseFadeGridConfig, ExchangeConfig, ForwardTestConfig, load_config(), _merge_daily_close_fade_config(), _merge_daily_close_fade_grid_config(), _merge_dataclass(), _merge_forward_test_config() (+19 more)
...
Cohesion: 0.14
Nodes (24): ArchiveKlineDownloadConfig, ArchiveManifestConfig, build_archive_trade_manifest(), _download_one_archive_kline(), _download_result(), _empty_download_results(), _empty_manifest(), fetch_directory_html() (+16 more)
...
- **Why does `main()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `ResearchConfig` connect `Community 6` to `Community 8`, `Community 1`, `Community 2`, `Community 4`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `read_dataset()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 10`, `Community 11`?**
...
- **Are the 42 inferred relationships involving `read_dataset()` (e.g. with `run_volume_trade_backtest()` and `run_volume_grid()`) actually correct?**
  _`read_dataset()` has 42 INFERRED edges - model-reasoned connections that need verification._
- **Are the 30 inferred relationships involving `main()` (e.g. with `load_config()` and `generate_fixture_data()`) actually correct?**
